...
public class UserRegistrationTest {
	...
	public void givenFirstName_WhenFirstLatterUpperCase_ShouldReturnTrue() {
		UserRegistration userRegistration = new UserRegistration();
		try {
			Assert.assertTrue(userRegistration.validateFirstName("Nivrithi"));
	...
	public void givenFirstName_WhenLessThanThreeChars_ShouldReturnFalse() {
		UserRegistration userRegistration = new UserRegistration();
		try {
			Assert.assertFalse(userRegistration.validateFirstName("Ni"));
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
	...
	public void givenFirstName_WhenHasNumber_ShouldReturnFalse() {
		try {
			Assert.assertFalse(userRegistration.validateFirstName("Nivr1"));
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
	}
	...
	public void givenFirstName_WhenHasSpecialChar_ShouldReturnFalse() {
		...
		try {
			result = userRegistration.validateFirstName("Nivrthi@");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
	...
	public void givenLastName_WhenFirstLetterUpperCase_ShouldReturnTrue() {
		boolean result = false;
		try {
			result = userRegistration.validateLastName("Roy");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
	...
	public void givenLastName_WhenHasNumber_ShouldReturnFalse() {
		boolean result = false;
		try {
			result = userRegistration.validateLastName("Nivrithi1");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
		Assert.assertFalse(result);
	...
	public void givenLastName_WhenHasSpecialChar_ShouldReturnFalse() {
		boolean result = false;
		try {
			result = userRegistration.validateFirstName("Roy@");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
		Assert.assertFalse(result);
	...
	public void givenPassword_WhenHasLessChars_ShouldReturnFalse() {
		boolean result = false;
		try {
			result = userRegistration.validatePassword("Nd1%M");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
		Assert.assertFalse(result);
	...
	public void givenPassword_WhenAtleast1UpperCase_ShouldReturnTrue() {
		boolean result = false;
		try {
			result = userRegistration.validatePassword("3Nmdg*nm");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
		Assert.assertTrue(result);
	...
	public void givenPassword_WhenAtleast1Number_ShouldReturnTrue() {
		boolean result = false;
		try {
			result = userRegistration.validatePassword("Mas1bt&Bn");
		} catch (UserRegistrationException exception) {
			exception.printStackTrace();
		}
		Assert.assertTrue(result);
